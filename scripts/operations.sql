...
INSERT INTO vinhos.vinho_tinto (nome_vinho, estilo) VALUES ('Château Margaux', 'Cabernet Sauvignon');
INSERT INTO vinhos.vinho_tinto (nome_vinho, estilo) VALUES ('Santa Rita 120', 'Merlot');
...
-- assumindo que carrinho criado tem o número 1 (chave estrangeira do carrrinho do usuário)
INSERT INTO vinhos.carrinho_produto (numero_carrinho, nome_vinho, quantidade, subtotal) 
VALUES (1, 'Château Margaux', 2, 2400.00);
INSERT INTO vinhos.carrinho_produto (numero_carrinho, nome_vinho, quantidade, subtotal) 
VALUES (1, 'Santa Rita 120', 3, 255.00);

-- ATUALIZAR QUANTIDADE NO CARRINHO
UPDATE vinhos.carrinho_produto
-- subtotal= 340.00 (85.00 x 4)
SET quantidade = 4, subtotal = 340.00 
WHERE numero_carrinho = 1 AND nome_vinho = 'Santa Rita 120';
...
-- numero (numero nota fiscal)
INSERT INTO vinhos.compras (numero, valor_total) 
VALUES (123, 2400.00);
-- assumindo que carrinho 1 está sendo finalizado
INSERT INTO vinhos.compra_carrinho_produto (numero_compra, numero_carrinho, nome_vinho, quantidade, subtotal) 
VALUES (123, 1, 'Château Margaux', 2, 2400.00);
...
JOIN vinhos.vinhos v ON t.nome_vinho = v.nome
WHERE t.estilo = 'Cabernet Sauvignon';

-- CONSULTAR VINHOS CARRINHO
SELECT u.nome, u.email, c.numero, cp.nome_vinho, cp.quantidade, cp.subtotal
...
-- REMOVER VINHO
DELETE FROM vinhos.vinhos WHERE nome = 'Château Margaux';
