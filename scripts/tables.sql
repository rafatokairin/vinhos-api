...
CREATE TABLE vinhos.vinho_tinto (
    ...
    CONSTRAINT fk_nome_vinho FOREIGN KEY (nome_vinho)
        REFERENCES vinhos.vinhos(nome) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE vinhos.carrinho_produto (
    ...
    CONSTRAINT fk_nome_vinho FOREIGN KEY (nome_vinho)
        REFERENCES vinhos.vinhos(nome) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT pk_carrinho_produto PRIMARY KEY (numero_carrinho, nome_vinho)
);
...
CREATE TABLE vinhos.compra_carrinho_produto (
    ...
    CONSTRAINT fk_carrinho_vinho FOREIGN KEY (numero_carrinho, nome_vinho)
        REFERENCES vinhos.carrinho_produto(numero_carrinho, nome_vinho) ON DELETE CASCADE ON UPDATE CASCADE,
